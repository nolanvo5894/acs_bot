...
If you don't see any relevant infomation to answer the question, then DO NOT provide an answer, MAKE SURE to say you 'DO NOT HAVE RELEVANT INFO'.
...
retriever = vectordb.as_retriever(search_kwargs={"k": 36})
